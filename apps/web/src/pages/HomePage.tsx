...
export const HomePage = () => {
    ...
    return (
        <div className="min-h-[100dvh] bg-gray-50">
            {/* Hero Section */}
            <div className="bg-blue-600 text-white py-8 sm:py-12 md:py-20">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold mb-4 sm:mb-6">
                        Tu viaje, tu comunidad.
                    </h1>
                    <p className="text-base sm:text-lg md:text-2xl mb-8 sm:mb-10 text-blue-100">
                        Comparte gastos, conoce gente y viaja cómodo con gudtrip.
                    </p>

                    {/* Search Box */}
                    <div className="bg-white p-3 sm:p-4 rounded-2xl shadow-lg max-w-4xl mx-auto flex flex-col md:flex-row gap-3 sm:gap-4">
                        ...
                        <button
                            ...
                            className="bg-blue-600 text-white px-6 sm:px-8 py-4 sm:py-3 rounded-xl font-bold hover:bg-blue-700 transition-colors flex items-center justify-center gap-2 w-full md:w-auto touch-manipulation min-h-touch"
                        >
